...
void FilterDialog_LoanApplications::connects()
{
    ...
    connect(_pushButton, &QPushButton::clicked, this, &FilterDialog_LoanApplications::applyFilter);
}

void FilterDialog_LoanApplications::renderingInterface()
{
...
void FilterDialog_LoanApplications::renderingFilter_1()
{
...
void FilterDialog_LoanApplications::renderingFilter_2()
{
...
void FilterDialog_LoanApplications::renderingFilter_3()
{
...
void FilterDialog_LoanApplications::renderingFilter_4()
{
...
void FilterDialog_LoanApplications::renderingConfirmationButton()
{
